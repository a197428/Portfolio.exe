...
Публичный снимок подтверждает клиентский workflow и Cloudflare-контур. Это управляемый MVP с ручным подтверждением результата. Формулировка AI-assisted описывает продуктовый workflow; встроенного LLM-вызова в проекте нет.
